...
# evaluation args
parser.add_argument('--weight_file', type = str, default='saved_weights/run_log_0909_train1234_cpu_2024-07-19_19:25:14.362053')
parser.add_argument('--result_file', type = str, default='./result/result_cpu1.res')
