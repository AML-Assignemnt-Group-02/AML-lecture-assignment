...
class Net(nn.Module):
    def __init__(self, kernel_size, num_filter):
        print('Model: 11 def __init__(self, kernel_size, num_filter):')
    ...
    def forward(self, traj, config):
        ...
        print('Model: 11 forward(self, traj, config):end')
        return conv_locs
